...
('Goldlife Liver & Kidney Supplement', 'Detox', 4.6, 78, 'Multi-cure dietary supplement that reduces cholesterol, reverses aging, boosts memory, strengthens bones, and supports liver and kidney health.', '{"Reduces cholesterol", "Liver detoxification", "Kidney support", "Boosts energy"}', '/images/products/product-liver-kidney.png', false, true),
