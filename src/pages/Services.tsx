...
const serviceCategories = [
  {
    icon: Stethoscope,
    title: "Holistic Health & Wellness Consultant",
    description: "Expert guidance for your complete physical and mental well-being using root-cause analysis.",
    featured: true,
  },
  {
    icon: Leaf,
    title: "Natural Healing Solution",
    description: "Curated herbal protocols and ancestral remedies for a wide range of common and chronic ailments.",
    featured: true,
  },
  {
    icon: Heart,
    title: "Body System Detoxification",
    description: "Deep internal cleansing programs to eliminate toxins and restore your organ systems' optimal function.",
    featured: true,
  },
  {
    icon: MessageSquare,
    title: "Counseling",
    description: "Empathetic health counseling to support your transition to a natural, healing lifestyle.",
    featured: false,
  },
  {
    icon: Pill,
    title: "Basic Health Test & Checks",
    description: "Routine blood pressure, blood sugar checks, and simple diagnostic health tests to monitor your vitals.",
    featured: false,
  },
  {
    icon: BookOpen,
    title: "Mini Health Massage",
    description: "Therapeutic massage techniques focused on stress relief and improving natural circulation.",
    featured: false,
  },
];
